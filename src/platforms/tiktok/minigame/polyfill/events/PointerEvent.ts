...
tt.onTouchStart(touchEventHandlerFactory('pointerdown'));
tt.onTouchMove(touchEventHandlerFactory('pointermove'));
tt.onTouchEnd(touchEventHandlerFactory('pointerup'));
tt.onTouchCancel(touchEventHandlerFactory('pointercancel'));
tt.onTouchCancel(touchEventHandlerFactory('pointerleave'));
